...
const ApplicationDetail = () => {
    ...
    const getData = async () => {
        const applicationDetail = await getCandidateDetail({
            role: 2,
            userId: userId,
            postId: postId
        })
        ...
        if(applicationDetail && applicationDetail.status === 200) {
            setApplicationDetail({
                selfIntroduction: applicationDetail.data.SelfIntroduction,
                file: URL.createObjectURL(Converter.getFile(applicationDetail.data.File, applicationDetail.data.Name)[0])
            })
        } else {
            ...
            <div className="col-12 mt-20 mb-35 grid-margin">
                <div className="card" style={{ backgroundColor: "#eaedff"}}>
                    <div className="card-body">
                        <h4 className="card-title">Thư giới thiệu của ứng viên</h4>
                        <br/>
                        <blockquote
                    ...
                    <div className="card-body">
                        <h4 className="card-title">CV của ứng viên</h4>
                        <br/>
                        <iframe
                            style={{
                                width: "100%",

...
function drawStuff() {
  ...
  var chart = new google.charts.Bar(document.getElementById('header-chart'));
  chart.draw(data, options);
};
...
// area statistics Ends



// Donut statistics Starts
...
// Donut statistics Ends


// Curve statistics Starts
(function($) {
